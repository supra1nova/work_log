...
<div class="container">
  ...
  <form method="post" action="/member/update">
    ...
    <table class="mb5" style="width: 80%; margin-left: auto; margin-right: auto">
      ...
      <tr>
        <th>이름</th>
        <td class="tc"><input type="text" name="memberName" value="${info.memberName}" placeholder="이름을 입력해 주세요"></td>
      </tr>
      <tr>
        <th>이메일</th>
        <td class="tc"><input type="text" name="memberEmail" value="${info.memberEmail}" placeholder="이메일을 입력해 주세요"></td>
      </tr>
      <tr>
        <th>등록일시</th>
    ...
    <div class="tr mb150" style="width: 80%; margin-left: auto; margin-right: auto">
      <button>저장</button>
      <button type="button" onclick="location.href='/member/view/${info.memberId}'">취소</button>
